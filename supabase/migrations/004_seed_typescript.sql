...
-- TypeScript modules: split into three difficulty levels (21 / 61 / 18 questions).

insert into modules (slug, name, description, type, total_questions) values
  ('typescript-1', 'TypeScript — Level 1', 'TypeScript basics — type annotations, primitives, tuples, simple unions, and `any` vs `unknown`.', 'dynamic', 21),
  ('typescript-2', 'TypeScript — Level 2', 'Intermediate TypeScript — generics with constraints, utility types, narrowing, discriminated unions, and classes.', 'dynamic', 61),
  ('typescript-3', 'TypeScript — Level 3', 'Advanced TypeScript — conditional types, `infer`, mapped types, distributive unions, and declaration merging.', 'dynamic', 18);

-- ============================================================
-- typescript-1
-- ============================================================

-- Question 0 [orig 0] (basic annotations) -----------------------------------------------
with q as (
  ...
  select id, null,
         ...
         0
  from modules where slug = 'typescript-1'
  returning id
)
...
-- Question 1 [orig 1] (basic annotations) -----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 2 [orig 2] (basic annotations) -----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 3 [orig 3] (basic annotations) -----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 4 [orig 4] (basic annotations) -----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 5 [orig 5] (basic annotations) -----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 6 [orig 7] (unknown vs any vs never) -----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 7 [orig 15] (interfaces vs type aliases) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 8 [orig 21] (union & intersection types) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 9 [orig 23] (union & intersection types) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 10 [orig 30] (literal types & as const) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 11 [orig 34] (literal types & as const) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 12 [orig 35] (function types) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 13 [orig 36] (function types) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 14 [orig 37] (function types) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 20 [orig 92] (tsconfig essentials) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 0 [orig 6] (unknown vs any vs never) -----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
  ...
  select id, null,
         ...
         0
  from modules where slug = 'typescript-2'
  returning id
)
insert into question_choices (question_id, label, is_correct, order_index)
select q.id, c.label, c.is_correct, c.order_index
...
-- Question 1 [orig 8] (unknown vs any vs never) -----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 2 [orig 9] (unknown vs any vs never) -----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 3 [orig 11] (unknown vs any vs never) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 4 [orig 12] (unknown vs any vs never) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 5 [orig 17] (interfaces vs type aliases) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 6 [orig 18] (interfaces vs type aliases) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 7 [orig 19] (union & intersection types) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 8 [orig 22] (union & intersection types) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 9 [orig 24] (discriminated unions & exhaustiveness) --------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 10 [orig 25] (discriminated unions & exhaustiveness) --------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 11 [orig 27] (discriminated unions & exhaustiveness) --------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 12 [orig 28] (discriminated unions & exhaustiveness) --------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 13 [orig 29] (discriminated unions & exhaustiveness) --------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 14 [orig 31] (literal types & as const) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 15 [orig 32] (literal types & as const) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 16 [orig 33] (literal types & as const) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 17 [orig 38] (function types) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 18 [orig 39] (function types) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 26 [orig 49] (keyof, typeof, indexed access) -----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 27 [orig 50] (keyof, typeof, indexed access) -----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 28 [orig 51] (keyof, typeof, indexed access) -----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 29 [orig 53] (keyof, typeof, indexed access) -----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 30 [orig 56] (mapped types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 31 [orig 58] (mapped types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 32 [orig 59] (mapped types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 33 [orig 66] (utility types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 34 [orig 67] (utility types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 35 [orig 68] (utility types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 36 [orig 69] (utility types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 37 [orig 70] (utility types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 38 [orig 71] (utility types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 39 [orig 72] (utility types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 40 [orig 73] (utility types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 55 [orig 93] (tsconfig essentials) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 56 [orig 94] (tsconfig essentials) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 57 [orig 95] (tsconfig essentials) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 58 [orig 96] (tsconfig essentials) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 59 [orig 97] (declaration files) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 60 [orig 99] (React + TS basics) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 0 [orig 10] (unknown vs any vs never) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
  ...
  select id, null,
         ...
         0
  from modules where slug = 'typescript-3'
  returning id
)
insert into question_choices (question_id, label, is_correct, order_index)
select q.id, c.label, c.is_correct, c.order_index
...
-- Question 1 [orig 13] (interfaces vs type aliases) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 2 [orig 14] (interfaces vs type aliases) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 3 [orig 16] (interfaces vs type aliases) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 4 [orig 20] (union & intersection types) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 5 [orig 26] (discriminated unions & exhaustiveness) --------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 6 [orig 52] (keyof, typeof, indexed access) -----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 7 [orig 54] (keyof, typeof, indexed access) -----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 8 [orig 55] (keyof, typeof, indexed access) -----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 9 [orig 57] (mapped types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 10 [orig 60] (mapped types) ---------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 11 [orig 61] (conditional types & infer) --------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 12 [orig 62] (conditional types & infer) --------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 13 [orig 63] (conditional types & infer) --------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 14 [orig 64] (conditional types & infer) --------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 15 [orig 65] (conditional types & infer) --------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 17 [orig 98] (declaration files) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
